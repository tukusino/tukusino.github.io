  ...
  const content = {
    about: {
      ...
      cards: [
        ...
        { title: '📍 事務所の所在地', text: 'つくし野区自治会事務所は、掛川市（つくし野区域内）に置かれています。' },
        { title: '🏘️ 構成世帯', text: '掛川市つくし野区域内の加入世帯を中心に構成されています。戸建て住宅および共同住宅の世帯が参加しています。1組・2組・3組・5組・6組・7組の全6組で組織されています。' }
      ]
    },
    roles: {
      eyebrow: '役員の役割と組織',
      ...
      cards: [
        ...
        { title: '🧹 クリーン当番と共同作業', text: 'ゴミ集積所のクリーン推進員は、満65歳以上80歳未満（4月1日時点）の対象世帯からの当番制とし、1人あたり1か月間担当します。共同草刈り作業に参加できない場合は、細則に基づき出不足料（1回につき1,000円。ただし満80歳以上や病気等の事情がある場合は免除）を納付いただきます。' }
      ]
    },
    rules: {
      eyebrow: '自治会のきまり',
      ...
      cards: [
        ...
        { title: '🔒 個人情報の保護方針', text: '本会で管理する名簿等の個人情報は、回覧板の伝達、緊急連絡、および区費の集金管理以外の目的には一切使用しません。本Webサイト上にも、個人の氏名や財務状況を特定する情報は掲載しません。' }
      ]
    }
  };
